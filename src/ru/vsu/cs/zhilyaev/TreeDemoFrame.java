...
public class TreeDemoFrame extends JFrame {
    ...
    private JButton buttonFindLevel;
...
//        tableOutput.setRowHeight(30);
        ...
        buttonFindLevel.addActionListener(actionEvent -> {
//            showSystemOut(() -> {
//                System.out.println("Посетитель:");
//                System.out.println(BinaryTreeAlgorithms.findMaxLevel(tree.getRoot(), (value, level)  ->  {
//                    System.out.println(value + " (уровень " + level + ")");
//                }) + " ");
//            });
            textAreaOut.setText("");
            ArrayList<Integer> list = BinaryTreeAlgorithms.findMaxLevel(tree.getRoot());
            for(int i = 0; i < list.size(); i++) {
               textAreaOut.append(list.get(i).toString() + ", ");
             }
        });
    }
